...
import com.example.venkatesh.presencesystem.Tracking;
import com.example.venkatesh.presencesystem.User;
...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener{
    ...
    //Init view
        ...
        toolbar.setTitle("SAFE PRESENCE SYSTEM");
 ...
 //FIREBASE
        ...
        counterRef= FirebaseDatabase.getInstance().getReference("lastOnline");  //creting new child name
        ...
        if(mLastLocation != null)
        {
            ...
            locations.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                    .setValue(new Tracking(FirebaseAuth.getInstance().getCurrentUser().getEmail(),
                            FirebaseAuth.getInstance().getCurrentUser().getUid(),String.valueOf(mLastLocation.getLatitude()),String.valueOf(mLastLocation.getLongitude())));
        }
        else
        {
